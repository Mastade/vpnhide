...
3. **Скрытие приложений** — скрывает выбранные установленные приложения от выбранных приложений-наблюдателей; полезно против проверок package visibility для VPN/proxy-клиентов.
